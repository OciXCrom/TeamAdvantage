...
public OnTeamWin()
{
	...
	{
		CC_SendMatched(0, iLoseTeam == CS_TEAM_CT ? CC_COLOR_BLUE : CC_COLOR_RED, "%L", LANG_PLAYER, "ADVANTAGE_GET_FLAGS", g_eSettings[ADVANTAGE_FLAGS], LANG_PLAYER, iLoseTeam == CS_TEAM_CT ? "ADVANTAGE_TEAM_CT" : "ADVANTAGE_TEAM_T", iMoney, g_iLoses[iLoseTeam])
	}
	else
	{
		CC_SendMatched(0, iLoseTeam == CS_TEAM_CT ? CC_COLOR_BLUE : CC_COLOR_RED, "%L", LANG_PLAYER, "ADVANTAGE_GET_NORMAL", LANG_PLAYER, iLoseTeam == CS_TEAM_CT ? "ADVANTAGE_TEAM_CT" : "ADVANTAGE_TEAM_T", iMoney, g_iLoses[iLoseTeam])
	}
